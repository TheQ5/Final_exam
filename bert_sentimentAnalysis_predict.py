...
class sentimentModel():
    ...
    def pass_sign_to_lineAndgui_or_nextModel(self, pred_num):
        if pred_num == 0 or pred_num == 1:
            ...
            return 2, "親愛的客戶，請您稍等一下，馬上會有專員為您服務。"
        elif pred_num == 3:
            return 3, "親愛的客戶，請您稍等一下，馬上會有專員為您服務。"

    def predict_and_to_pass_sign(self, text):
        ...
        sign, content = self.pass_sign_to_lineAndgui_or_nextModel(pred_num)
        print(f"預測結果為:{pred}")
        print("=" * 25 + "預測結束" + "=" * 25)
        return sign, content
